...
(function(){
  ...
  document.querySelectorAll('.pill-section').forEach(root=>{
    ...
    const cfg = {
      ...
      pillSrc:        root.dataset.pillSrc || 'tablets_ic.png',
      nameEng:        root.dataset.hoverNameEng || 'eo-pill/eo_name_eng.png',
      infoEng:        root.dataset.hoverInfoEng || 'eo-pill/eo_info_eng.png',
      nameIta:        root.dataset.hoverNameIta || 'eo-pill/eo_name_ita.png',
      infoIta:        root.dataset.hoverInfoIta || 'eo-pill/eo_info_ita.png',
    };
